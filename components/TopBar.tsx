...
import { FaBell, FaComments, FaShoppingCart, FaCog, FaSearch  } from 'react-icons/fa';

export default function TopBar() {
  return (
    <div className="w-full lg:w-[90%] lg:mx-auto flex flex-col md:flex-row items-center justify-between gap-4 sm:mt-300">
      {/* Search Bar */}
      <div className="flex items-center lg:w-[71%] md:w-[50%] sm:width-[100%] relative">
        <input
          type="text"
     ...
     <div className='flex lg:gap-10 md:gap-5 lg:w-[25%] items-center justify-between  md:w-[45%] sm:w-full sm:gap-5'>
       {/* Icons */}
      <div className="flex items-center gap-4">
        <IconBadge icon={<FaBell />} count={3} color="text-blue-400" />
        <IconBadge icon={<FaComments />} count={2} color="text-blue-400" />
        <IconBadge icon={<FaShoppingCart />} count={4} color="text-indigo-400" />
        <IconBadge icon={<FaCog />} count={1} color="text-red-400" />
      </div>

      {/* Profile */}
      <div className="flex items-center">
        <p className="text-sm text-gray-700">Hello, <span className="font-medium">Miracle</span></p>
        <img
